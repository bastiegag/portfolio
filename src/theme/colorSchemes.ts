		...
		dark: {
			palette: {
				scene: {
					...
					cloud: {
						back: {
							light: colors.cloudBackLight_24,
							mid: colors.cloudBackMid_24,
							dark: colors.cloudBackDark_24,
						},
						shade: {
							light: colors.cloudShadeLight_24,
							mid: colors.cloudShadeMid_24,
							dark: colors.cloudShadeDark_24,
						},
						far: {
							light: colors.cloudFarLight_24,
							mid: colors.cloudFarMid_24,
							dark: colors.cloudFarDark_24,
						},
					},
					island: {
						sand: {
							light: colors.islandSandLight_24,
							mid: colors.islandSandMid_24,
							dark: colors.islandSandDark_24,
						},
						grass: {
							light: colors.islandGrassLight_24,
							dark: colors.islandGrassDark_24,
						},
						water: colors.islandWater_24,
						wet: colors.islandWet_24,
						shadow: colors.islandShadow_24,
					},
					ocean: {
						back: {
