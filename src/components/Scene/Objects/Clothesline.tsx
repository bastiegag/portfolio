        ...
        >
            <g id={id}>
                ...
                <Link url={config.linkedin} title="LinkedIn">
                    <g id={`${id}-5`} className="social linkedin link">
                        <path
                ...
                <Link url={config.instagram} title="Instagram">
                    <g id={`${id}-6`} className="social instagram link">
                        <path
                            className="towel-light"
                            fill={colors.towel.light}
                ...
                <Link url={config.vimeo} title="Vimeo">
                    <g id={`${id}-7`} className="social vimeo link">
                        <path
                            className="towel-light"
                            fill={colors.towel.light}
                ...
                <Link url={config.github} title="Github">
                    <g id={`${id}-8`} className="social github link">
                        <path
                            className="towel-light"
                            fill={colors.towel.light}
