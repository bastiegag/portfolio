...
export const Waves = ({ params }: SceneComponentProps) => {
	const id = useId();

	useParallax(`#${CSS.escape(id)}`, 0, 0, params.m, {
		pos: 'y',
		skew: true,
	});
