...
const CustomSvg = styled('g', {
	...
	'.island-grass': {
		fill: 'url(#island-grass-gradient)',
	},
	'.island-sand': {
		fill: 'url(#island-sand-gradient)',
	},
}));

export const Island = () => {
	const colors = useTheme().palette.scene.island;

	return (
		<CustomSvg transform={`translate(17,286)`}>
			<defs>
				<linearGradient
					id="island-sand-gradient"
					x1="435.5"
					y1="24.5"
					x2="435.5"
					y2="88.1"
				...
				>
					...
					<stop offset=".6" stopColor={colors.sand.mid} />
					<stop offset="1" stopColor={colors.sand.light} />
				</linearGradient>
				<linearGradient
					id="island-grass-gradient"
					x1="431.6"
					y1="70.6"
					x2="431.6"
					y2="92.2"
					...
					gradientUnits="userSpaceOnUse"
				>
					<stop offset="0" stopColor={colors.grass.light} />
					<stop offset="1" stopColor={colors.grass.dark} />
				</linearGradient>
			</defs>
			<path
				className="island-water animate"
