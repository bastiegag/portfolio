...
export const Palm3 = () => {
	...
	return (
		<CustomSvg className="palm palm-3" transform={`translate(588,128)`}>
			<g className="leaf leaf-1">
				<path
					className="leaf-darker"
